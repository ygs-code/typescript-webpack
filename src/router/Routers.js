 ...
 * @FilePath: /react-ssr-lazy-loading/src/router/Routers.js
 * @Description:
 */
import NoPages from "src/components/404";
import Loading from "src/components/Loading";
import {toComponent} from "src/router";
import {
  Route,
  Router,
  Switch as Routes
} from "src/router/react-lazy-router-dom";
