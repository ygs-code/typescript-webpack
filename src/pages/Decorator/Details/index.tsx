...
class Index  extends FormPage<Props, State> {
  ...
  mapSubmitData = (formData: InitData): SubmitData => {
    ...
    const {
      phone,
      region: { alpha2Code, callingCodes },
    } = mobile;
    ...
    return {
      ...
      filePaths: [
        ...
        {
          fileName: filePaths.behindImg.fileName,
          containerName: filePaths.behindImg.containerName,
          storageAccountName: filePaths.behindImg.storageAccountName,
        },
      ],
  ...
  getFields = (): FieldsType[] => {
    ...
    const { setFieldsValue = () => {}, getFieldsValue = () => {} } =
      this.form || {};

    const { importance: { type } = {}, documentType } =
            ...
            rules: [
              {
                ...
                validator: (_: any, $value = {}) => {
                  const { phone, region: { value } = {} } = $value as { phone?: string; region?: { value?: string } };
      ...
      : [
            ...
            rules: [
              {
                ...
                validator: (
                  _: any,
                  value: {
                    behindImg?: { url?: string; status?: string };
                    frontImg?: { url?: string; status?: string };
                  } = {}
                ) => {
                  const { behindImg = {}, frontImg = {} } = value;
                  ...
                  if (
                    behindImg.status == 'error' ||
                    frontImg.status == 'error'
                  ) {
                    return Promise.reject(
                      new Error('证件上传失败,请删除重新上传')
                    );
                  }

                  if (
                    behindImg.status == 'uploading' ||
                    frontImg.status == 'uploading'
                  ) {
          ...
          },
          {
            ...
            render: ({
              ...
              return (
                <Email disabled={readOnly} value={value} onChange={onChange} />
              );
            },
          },
          {
            ...
            //    extra:'添加或者修改邮箱需要验证邮箱'
            // },
            render: (props: { value: string; onChange: Function }) => {
              const { value, onChange } = props;
              return (
                <Phone disabled={readOnly} value={value} onChange={onChange} />
              );
              // return <EmailPhone
              //   readOnly={readOnly}
              //   disabled={readOnly}
            ...
            rules: [
              {
                required: true,
                validator: (_: any, $value = {}) => {
                  const { phone, region: { value } = {} } = $value;
      ...
      <div className="form-page personal-data-write">
        <div
          ...
          */}
          ...
          <div className="personal-data-write-form-box">
            {this.renderForm()}
          </div>

          <div className="personal-data-write-button-box">
            {reviewStatus === 0 || reviewStatus === 1 ? null : (
              <Button
                type="primary"
                style={{
                  padding: '0 40px',
            ...
            {reviewStatus == 1 ? (
              <div className="personal-data-write-button-box-tip">
                <span>*</span>
                {reviewStatus == 2
              ...
              return [
                ...
                },
                {
                  ...
                  render: (props: {
                    ...
                    return (
                      <Input value={`${prefixName}${lastName}`} disabled>
                        {' '}
                      </Input>
                    );
                  },
