    ...
    render() {
        ...
        return <div style={{
            ...
            <Upload
                ...
                value={
                    value.frontImg ? [value.frontImg] : undefined
                }
                onChange={(v: any[] = []) => {
                    onChange({
                        behindImg: this.props?.value?.behindImg,
                        frontImg: v[0]
                    })
                }}
            >
            ...
            <Upload
                ...
                value={
                    value.behindImg ? [value.behindImg] : undefined
                }
                onChange={(v: any[] = []) => {
                    onChange({
                        frontImg: this.props?.value?.frontImg,
                        behindImg: v[0]
                    })
                }}
            >
